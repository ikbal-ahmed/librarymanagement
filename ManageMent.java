...
public class ManageMent extends javax.swing.JFrame {
    ...
    Employee employee;
    int i = 0;
    String column_name[] = {"Librarian ID", "Name", "Gender", "Address", "Phone", "E-mail"};
    ...
    public ManageMent() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(ManageMent.this, ex.getMessage());
        }
...
//    }
        ...
        jInternalFrame2Layout.setHorizontalGroup(
            ...
            .addGroup(jInternalFrame2Layout.createSequentialGroup()
                ...
                .addGroup(jInternalFrame2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(employeeButton, javax.swing.GroupLayout.DEFAULT_SIZE, 279, Short.MAX_VALUE))
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        if (admin.setValue == 1) {
            ...
            JOptionPane.showMessageDialog(ManageMent.this, "Please login first as an admin!");
        }
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        ...
        if (admin.setValue == 1) {
            try {
                ...
                JOptionPane.showMessageDialog(ManageMent.this, "You must select a row.");
            }
        } else {
            JOptionPane.showMessageDialog(ManageMent.this, "Please login first as an admin!");
        }
...
//                i++;
    ...
    private void jMenu1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu1MouseClicked
        new LibrarianRequest().setVisible(rootPaneCheckingEnabled);
        this.dispose();
    ...
    String name, email, phone, address, sex, id, dob, dept;
    String addPerform;
