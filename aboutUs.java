...
public class aboutUs extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Library Management Sytem");

        jLabel3.setFont(new java.awt.Font("Bookman Old Style", 0, 14)); // NOI18N
        jLabel3.setText("<html> Owners: <br> - Ikbal Ahmed(1108015) <br> - Sharmin Akter(1108048) <br> - Shuraiya Soni(1108050) <html>");

        jLabel4.setFont(new java.awt.Font("Bookman Old Style", 0, 14)); // NOI18N
        jLabel4.setText("<html> Supervisor: <br> - Kamal Hossain Chowdhury <br> Assistant Professor <br> Dept. Of CSE <br> Comilla University <html>");
