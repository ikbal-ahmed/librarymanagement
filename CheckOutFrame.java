...
public class CheckOutFrame extends javax.swing.JFrame {
    ...
    Book book;
    int i = 0;
    String column_name[] = {"Student ID", "Student Name", "ISBN", "Title", "Author", "Department"};
    ...
    public CheckOutFrame() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(CheckOutFrame.this, ex.getMessage());
        }
...
//        emailLabel.setText(StudentManagement.email2);
        ...
        try {
            ...
            books = connect.statement.executeQuery("SELECT * FROM CHECKIN");
            while (books.next()) {
...
//                copies = books.getInt(5);
                ...
                isbn = books.getString(3);
                title = books.getString(4);
                author = books.getString(5);
                dept = books.getString(6);
                tablemodel.addRow(new Object[]{id, name, isbn, title, author, dept});
                // i++;
            ...
            jTable1.addMouseListener(new MouseAdapter() {
                ...
                public void mousePressed(MouseEvent me) {
                    ...
                    if (me.getClickCount() == 2) {
                        ...
                        tablemodel2.addRow(new Object[]{data[row][0], data[row][1], data[row][2],
            ...
            JOptionPane.showMessageDialog(CheckOutFrame.this, "Communications link failure! Check your database connecttion.");
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Check-Out", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 0, 18))); // NOI18N
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Requested Book List", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 0, 14))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            d1 = jXDatePicker1.getDate() ;
            d2 = jXDatePicker2.getDate();
            long diff = d1.getTime() - d2.getTime();
            System.out.println(formater.format(cal));
            connect.statement.executeUpdate("INSERT INTO CHECKOUT VALUES (' " + data[row][0] + "','"
                    + data[row][1] + "','" + data[row][2] + "','" + data[row][3] + "','"
                    + data[row][4] + "','" + data[row][5] + "','" + formater.format(jXDatePicker1.getDate())
